...
public class MyItemDecoration extends RecyclerView.ItemDecoration implements View.OnClickListener {
...
//            if (position % 6 < 3) {
//                if (position % 6 == 0) {
//                    titleTV = ((TextView) decorView.findViewById(R.id.item_title));
//                    titleTV.setText("歌单" + (position / 6));
